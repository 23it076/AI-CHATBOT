...
const ResourcesPage = () => {
  return (
    <div className="flex-grow flex flex-col items-center min-h-[calc(100vh-80px)] w-full bg-background animate-in fade-in duration-500 py-12">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Card className="overflow-hidden border border-border shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 rounded-2xl bg-card group">
            <div className="p-8">
              <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <BarChart3 className="w-8 h-8 text-primary" />
              </div>
              <h3 className="text-2xl font-bold text-foreground mb-3">Engineering Cutoffs</h3>
              ...
              <Link href="/engineering-cutoffs">
                <Button className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white rounded-xl py-6 shadow-md shadow-primary/20 font-semibold flex items-center justify-center group-hover:shadow-lg transition-all">
                  View Cutoffs
          ...
          <Card className="overflow-hidden border border-border shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 rounded-2xl bg-card group">
            <div className="p-8">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-3">Scholarships</h3>
              <p className="text-muted-foreground mb-6 text-sm leading-relaxed">
          ...
          <Card className="overflow-hidden border border-border shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 rounded-2xl bg-card group">
            <div className="p-8">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-3">Colleges by Location</h3>
              <p className="text-muted-foreground mb-6 text-sm leading-relaxed">
